...
func run(ctx context.Context, log *logger.Logger) error {
	...
	log.Info(ctx, "startup", "status", "initalizing authentication support")

	// Load private keys files from disk. We can assume some system like
	// Vault has created these files alreadyt. How that happens is not our
	// concern
	ks := keystore.New()
